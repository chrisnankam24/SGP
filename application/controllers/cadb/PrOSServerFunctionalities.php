...
class PrOSServerFunctionalities extends CI_Controller  {
    ...
    public function __construct()
    {
        ...
        $this->client = new SoapClient(__DIR__ . '/wsdl-local/ProblemReportNotificationService.wsdl', array(
            "trace" => false,
    ...
    public function index(){
        ...
        $server = new SoapServer(__DIR__ . '/wsdl-local/ProblemReportOperationService.wsdl');
